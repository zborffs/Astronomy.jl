...
\begin{homeworkProblem}
    ...
    We solve this problem by first drawing a cross-sectional diagram of earth as hinted at in the question.\\
     ...
     \begin{figure}[!h]
       	\includegraphics[width=0.5\textwidth]{EarthDiagram2.png}
        	\centering
...
\begin{homeworkProblem}
	...
	\begin{figure}[!h]
 	...
 	The equation describing the best-fit line is: \(y \approx 0.665 x + 0.002 \hspace{2pt}[AU/y]\). The R-Squared value, which quantifies the quality of the regression. is \(>0.99999\) indicating a very strong, positive correlation between these two parameters.\\
 	
 	Please see \href{https://github.com/zborffs/Astronomy.jl}{my github repo} for details on computations, data, plots, and figures.
\end{homeworkProblem}
